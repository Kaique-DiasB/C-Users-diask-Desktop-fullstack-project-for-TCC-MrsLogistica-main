       ...
       <div class="cardBox">
            <div class="card">
                <div>
                    ...
                    <?php
                            ...
                            $result = mysqli_query($conn, "SELECT COUNT(*) as total FROM OrdensDeServico WHERE OrdensDeServico.idEmpreiteira = " . $_SESSION['ID_EMPREI']);
            ...
            <div class="card">
                <div>
                    ...
                    <?php
                            include_once('conexao.php');
                            $result = mysqli_query($conn,"SELECT COUNT(*) as total from OrdensDeServico where idStatus = 1 AND OrdensDeServico.idEmpreiteira = " . $_SESSION['ID_EMPREI']);
                            $row = mysqli_fetch_assoc($result);
                            $count = $row['total'];
                            echo $count;
                    ?>
            ...
            <div class="card">
                <div>
                    ...
                    <?php
                            include_once('conexao.php');
                            $result = mysqli_query($conn,"SELECT COUNT(*) as total from OrdensDeServico where idStatus = 3 AND OrdensDeServico.idEmpreiteira = " . $_SESSION['ID_EMPREI']);
                            $row = mysqli_fetch_assoc($result);
                            $count = $row['total'];
                            echo $count;
                    ?>
            ...
            <div class="card">
                <div>
                    ...
                    <?php
                        ...
                        $result = mysqli_query($conn, "SELECT COUNT(*) as total FROM OrdensDeServico WHERE DATE(dataAbertura) =  CURDATE() AND OrdensDeServico.idEmpreiteira = " . $_SESSION['ID_EMPREI']);
                        $row = mysqli_fetch_assoc($result);
                        $count = $row['total'];
                        echo $count;
                    ?>
    ...
    <div class="details">
        <div class="recentOs">
            <div class="cardHeard">
                ...
                <a href="consulta.php" target="screen" class="btn">Ver todas</a>
            </div>
...
$sql = "SELECT OS.titulo, Sedes.nome AS nomeSede, Empreiteiras.nome AS nomeEmpreiteira, StatusOs.nameStatus AS status
        ...
        WHERE OS.idEmpreiteira = " . $_SESSION['ID_EMPREI'] . "
