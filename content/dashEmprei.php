    ...
    <div class="container">
        <div class="navegation">
            <ul>
                ...
                <li>
                    <a href="homeEmprei.php" target="screen">
                        <span class="icon">
                ...
                <li>
                <a href="../content/cadastrar.php" target="screen">
                        <span class="icon">
                ...
                <li>
                <a href="consulta.php" target="screen">
                        <span class="icon">
        ...
        <div class="main">
            ...
            <div class="screenView">
                <iframe class="responsive-iframe" name = "screen" width = "100%" height = "100%" frameborder = "0" src="homeEmprei.php"></iframe>
            </div>
        </div>
